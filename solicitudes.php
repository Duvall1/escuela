...
<div> <input type="button" onclick="location='registro_alumno.php'" value="Registrar"> </div>
                ...
                ?>
                                        <tr>
                                            ...
                                            <td><?php if ($value['id_usuario'] != $_SESSION['id_usuario']){ ?> <div> <a href="php/users/user_controler.php?cam_tip&id=<?=$value['id_usuario']?>&tip=<?=$value['tipo_usu']?>" class= "btn btn-success" >Cambiar usuario</a> <?php } ?></td> 
